...
<input type="hidden" name="action" id="action" value="1-summer">
<div class="col-md-2">
<div class="form-group">
 ...
 $.ajax({url: url,
          ...
          if (num == 0) {
            ...
            $('#results').append('<div class="row"><div class="col-md-4 col-md-offset-4">' +
                                 '<a role="button" href="welcome.php" class="btn btn-warning btn-block">' +
            ...
            $('#links').append( '<a role="button" class="btn btn-warning pull-right"' +
                                 'href="reservation.php?action=2&start_date=' + start_date + '&end_date=' + end_date +'&rooms=' + rooms+ '"' +
