...
require "../../Models/configuration/db_prep.php";
require "../../Models/configuration/table-configuration.php";
...
<div class="row">
<div class="col-md-12">
<h1 class="page-title"><i class="fas fa-caret-right"></i>&nbsp; Sign Up</h1> 
</div>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="form-group">
<button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary pull-right">Sign Up </button>    
</div>
</div>
<p style="clear:both;"></p>
<p class="prompt" style="margin:40px 0;float:right;">Already have an account? <a href="signin.php">Sign In</a></p>
</div>
</form>
</div>
</div>
